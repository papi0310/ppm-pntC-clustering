...
with open(sys.argv[1], 'r') as fin:
  ...
  good_gcfs = set()
  with open('/Vagabundo/monica/notes/virtual_env/Importance-tri_sign-0_03-0', 'r') as f:
    for line in f:
  ...
  for line in fin:
    ...
    if gcf != current_gcf or pos - last_pos > 11 or pos - last_pos < 0:
      if current_gcf is not None:
        if has_pngc and has_pep_mutase and current_gcf in good_gcfs:
  ...
  with open(sys.argv[1] + '_jaccard_matrix', 'w') as fout:
